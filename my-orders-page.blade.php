                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody>
                          ...
                          if ($order->status == 'delivered'){
                             $status == '<span class="bg-orange-700 py-1 px-3 rounded text-white shadow">Delivered</span>';
                          }
                         ...
                         if($order->payment_status == 'failed'){
                          ...
                          <tr class="odd:bg-white even:bg-gray-100 dark:odd:bg-slate-900 dark:even:bg-slate-800"wire:key='{{ $order->id }}'>
                           <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">{{ $order->id }}</td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200"><span class="bg-orange-500 py-1 px-3 rounded text-white shadow">New</span>
                            {!! $status !!}
                            </td>
